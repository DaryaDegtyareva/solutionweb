      ...
      children: [
        ...
        },
        {
          ...
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'User',url:'/apps/user/user-list' ,active: true},
            ],
            pageTitle: 'UserView',
            rule: 'admin'
          }
        ...
        },
        {
            ...
            component: () => import('@/views/apps/package/Package.vue'),
            meta: {
              breadcrumb: [
                { title: 'Home', url: '/' },
                { title: 'PricingPackages', active: true }
              ],
              pageTitle: 'PricingPackages',
              rule: 'admin'
            }
          },
        {
            ...
            component: () => import('@/views/apps/package/Payment.vue'),
            meta: {
              breadcrumb: [
                { title: 'Home', url: '/' },
                { title: 'PaymentSettings', active: true }
              ],
          ...
          },
          {
            ...
            component: () => import('@/views/apps/package/Category.vue'),
            meta: {
              breadcrumb: [
                { title: 'Home', url: '/' },
                { title: 'BusinessCategory', active: true }
              ],
              pageTitle: 'BusinessCategory',
              rule: 'admin'
            }
          },
          {
            path: '/apps/invoice',
            name: 'Invoices',
            component: () => import('@/views/apps/package/invoice.vue'),
            meta: {
              breadcrumb: [
                { title: 'Home', url: '/' },
          ...
          //   path: '/apps/country',
          //   name: 'Countries',
          //   component: () => import('@/views/apps/country/country.vue'),
          //   meta: {
          //     breadcrumb: [
          //       { title: 'Home', url: '/' },
          //       { title: 'Countries', active: true }
          //     ],
          //     pageTitle: 'Countries',
          //     rule: 'admin'
          //   }
