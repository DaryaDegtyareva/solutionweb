...
var _moduleTodo = _interopRequireDefault(__webpack_require__(/*! @/store/todo/moduleTodo.js */ "./resources/js/src/store/todo/moduleTodo.js"));

var _TodoAddNew = _interopRequireDefault(__webpack_require__(/*! ./TodoAddNew.vue */ "./resources/js/src/views/apps/todo/TodoAddNew.vue"));

var _TodoTask = _interopRequireDefault(__webpack_require__(/*! ./TodoTask.vue */ "./resources/js/src/views/apps/todo/TodoTask.vue"));

var _TodoFilters = _interopRequireDefault(__webpack_require__(/*! ./TodoFilters.vue */ "./resources/js/src/views/apps/todo/TodoFilters.vue"));

var _TodoEdit = _interopRequireDefault(__webpack_require__(/*! ./TodoEdit.vue */ "./resources/js/src/views/apps/todo/TodoEdit.vue"));
...
var _default = {
  ...
  components: {
    TodoAddNew: _TodoAddNew.default,
    TodoTask: _TodoTask.default,
    TodoFilters: _TodoFilters.default,
    TodoEdit: _TodoEdit.default,
    VuePerfectScrollbar: _vuePerfectScrollbar.default
  },
  created: function created() {
    this.$store.registerModule('todo', _moduleTodo.default);
    this.setSidebarWidth();
...
var _default = {
  ...
  methods: {
    clearFields: function clearFields() {
      (0, _assign.default)(this.taskLocal, {
        title: '',
        desc: '',
        isCompleted: false,
        isImportant: false,
    ...
    addTodo: function addTodo() {
      ...
      this.$validator.validateAll().then(function (result) {
        if (result) {
          _this.$store.dispatch('todo/addTask', (0, _assign.default)({}, _this.taskLocal));
...
var _default = {
  ...
  data: function data() {
    return {
      taskLocal: (0, _assign.default)({}, this.$store.getters['todo/getTask'](this.taskId))
    };
  },
  computed: {
    activePrompt: {
  ...
  methods: {
    removeTodo: function removeTodo() {
      ...
      this.$store.dispatch('todo/updateTask', (0, _assign.default)({}, this.taskLocal, {
        isTrashed: true
      })).then(function () {
        // Fetch Tasks
    ...
    init: function init() {
      this.taskLocal = (0, _assign.default)({}, this.$store.getters['todo/getTask'](this.taskId));
    },
...
var _moduleTodoState = _interopRequireDefault(__webpack_require__(/*! ./moduleTodoState.js */ "./resources/js/src/store/todo/moduleTodoState.js"));

var _moduleTodoMutations = _interopRequireDefault(__webpack_require__(/*! ./moduleTodoMutations.js */ "./resources/js/src/store/todo/moduleTodoMutations.js"));

var _moduleTodoActions = _interopRequireDefault(__webpack_require__(/*! ./moduleTodoActions.js */ "./resources/js/src/store/todo/moduleTodoActions.js"));

var _moduleTodoGetters = _interopRequireDefault(__webpack_require__(/*! ./moduleTodoGetters.js */ "./resources/js/src/store/todo/moduleTodoGetters.js"));
...
var _default = {
  namespaced: true,
  state: _moduleTodoState.default,
  mutations: _moduleTodoMutations.default,
  actions: _moduleTodoActions.default,
  getters: _moduleTodoGetters.default
};
exports.default = _default;
...
var _default = {
  ...
  fetchTasks: function fetchTasks(_ref2, payload) {
    ...
    return new _promise.default(function (resolve, reject) {
      _axios.default.get('/api/apps/todo/tasks', {
        params: {
  ...
  fetchTags: function fetchTags(_ref3) {
    ...
    return new _promise.default(function (resolve, reject) {
      _axios.default.get('/api/apps/todo/tags').then(function (response) {
  ...
  addTask: function addTask(_ref4, task) {
    ...
    return new _promise.default(function (resolve, reject) {
      _axios.default.post('/api/apps/todo/tasks/', {
        task: task
      }).then(function (response) {
        commit('ADD_TASK', (0, _assign.default)(task, {
          id: response.data.id
        }));
        resolve(response);
      }).catch(function (error) {
  ...
  updateTask: function updateTask(_ref5, task) {
    ...
    return new _promise.default(function (resolve, reject) {
      _axios.default.post("/api/apps/todo/task/".concat(task.id), {
        task: task
      }).then(function (response) {
...
var _default = {
  ...
  UPDATE_TASK: function UPDATE_TASK(state, task) {
    ...
    (0, _assign.default)(state.tasks[taskIndex], task);
  }
};
exports.default = _default;
...
/* harmony import */ var _Todo_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Todo.vue?vue&type=style&index=0&lang=scss& */ "./resources/js/src/views/apps/todo/Todo.vue?vue&type=style&index=0&lang=scss&");
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _TodoAddNew_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _TodoAddNew_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoAddNew_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoAddNew_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoAddNew_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoAddNew_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoAddNew_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _TodoEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _TodoEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _TodoFilters_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _TodoFilters_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoFilters_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoFilters_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoFilters_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoFilters_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoFilters_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _TodoTask_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _TodoTask_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoTask_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoTask_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoTask_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoTask_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TodoTask_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default.a); 
