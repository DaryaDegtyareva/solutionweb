    ...
    <div>
        ...
        <div class="vx-row">
            ...
            <div class="vx-col w-full md:w-1/3 lg:w-1/3 xl:w-1/3 mb-base">
                ...
                <vx-card title="Owners Analytics">
                    <!-- SLOT = ACTIONS -->
                    <template slot="actions">
            ...
            <div class="vx-col w-full md:w-2/3">
                <vx-card title="Owner Retention">
                    <div class="flex">
                        <span class="flex items-center"><div class="h-3 w-3 rounded-full mr-1 bg-primary"></div><span>Active Owners</span></span>
                        <span class="flex items-center ml-4"><div class="h-3 w-3 rounded-full mr-1 bg-danger"></div><span>Trial Owners</span></span>
                    </div>
