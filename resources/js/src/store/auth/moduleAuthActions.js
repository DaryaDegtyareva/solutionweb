...
export default {
  ...
  registerUserJWT ({ commit }, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      auth.registerACompany(payload, (response)=>{
          // Redirect User
  ...
  registerUser({commit}, payload) {
        auth.registerACompany(payload, (res)=>{
            if(res.accessToken){
                payload.notify({
                    title: 'Account Created',
                    text: 'You are successfully registered!',
                ...
                commit('UPDATE_USER_INFO', res.userData, {root: true})
                router.push(router.currentRoute.query.to || '/');
            }else{
                payload.notify({
                    title: 'Error',
    ...
    newLogin({ commit, state, dispatch }, payload) {
