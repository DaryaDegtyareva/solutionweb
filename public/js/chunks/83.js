...
var _vueSimpleCalendar = __webpack_require__(/*! vue-simple-calendar */ "./node_modules/vue-simple-calendar/dist/CalendarView.umd.js");

var _moduleCalendar = _interopRequireDefault(__webpack_require__(/*! @/store/calendar/moduleCalendar.js */ "./resources/js/src/store/calendar/moduleCalendar.js"));
...
var _locale = __webpack_require__(/*! vuejs-datepicker/src/locale */ "./node_modules/vuejs-datepicker/src/locale/index.js");
...
var _default = {
  ...
  created: function created() {
    this.$store.registerModule('calendar', _moduleCalendar.default);
...
var _moduleCalendarState = _interopRequireDefault(__webpack_require__(/*! ./moduleCalendarState.js */ "./resources/js/src/store/calendar/moduleCalendarState.js"));

var _moduleCalendarMutations = _interopRequireDefault(__webpack_require__(/*! ./moduleCalendarMutations.js */ "./resources/js/src/store/calendar/moduleCalendarMutations.js"));

var _moduleCalendarActions = _interopRequireDefault(__webpack_require__(/*! ./moduleCalendarActions.js */ "./resources/js/src/store/calendar/moduleCalendarActions.js"));

var _moduleCalendarGetters = _interopRequireDefault(__webpack_require__(/*! ./moduleCalendarGetters.js */ "./resources/js/src/store/calendar/moduleCalendarGetters.js"));
...
var _default = {
  namespaced: true,
  state: _moduleCalendarState.default,
  mutations: _moduleCalendarMutations.default,
  actions: _moduleCalendarActions.default,
  getters: _moduleCalendarGetters.default
};
exports.default = _default;
...
var _default = {
  addEvent: function addEvent(_ref, event) {
    ...
    return new _promise.default(function (resolve, reject) {
      _axios.default.post('/api/apps/calendar/events/', {
        event: event
      }).then(function (response) {
        commit('ADD_EVENT', (0, _assign.default)(event, {
          id: response.data.id
        }));
        resolve(response);
  ...
  fetchEvents: function fetchEvents(_ref2) {
    ...
    return new _promise.default(function (resolve, reject) {
      _axios.default.get('/api/apps/calendar/events').then(function (response) {
  ...
  fetchEventLabels: function fetchEventLabels(_ref3) {
    ...
    return new _promise.default(function (resolve, reject) {
      _axios.default.get('/api/apps/calendar/labels').then(function (response) {
  ...
  editEvent: function editEvent(_ref4, event) {
    ...
    return new _promise.default(function (resolve, reject) {
      _axios.default.post("/api/apps/calendar/event/".concat(event.id), {
        event: event
      }).then(function (response) {
  ...
  removeEvent: function removeEvent(_ref5, eventId) {
    ...
    return new _promise.default(function (resolve, reject) {
      _axios.default.delete("/api/apps/calendar/event/".concat(eventId)).then(function (response) {
  ...
  eventDragged: function eventDragged(_ref6, payload) {
    ...
    return new _promise.default(function (resolve, reject) {
      _axios.default.post("/api/apps/calendar/event/dragged/".concat(payload.event.id), {
        payload: payload
      }).then(function (response) {
        // Convert Date String to Date Object
        var event = response.data;
...
var _default = {
  ...
  UPDATE_EVENT: function UPDATE_EVENT(state, event) {
    ...
    (0, _assign.default)(state.events[eventIndex], event);
  },
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _SimpleCalendar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _SimpleCalendar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _SimpleCalendar_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SimpleCalendar.vue?vue&type=style&index=0&lang=scss& */ "./resources/js/src/views/apps/calendar/SimpleCalendar.vue?vue&type=style&index=0&lang=scss&");
...
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SimpleCalendar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SimpleCalendar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SimpleCalendar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SimpleCalendar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SimpleCalendar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default.a); 
